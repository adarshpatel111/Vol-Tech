...
export default function AboutPageClient() {
  const clients = [
    ...
    {
      name: "SILVASSA INDUSTRIES LTD.(Reliance group)",
      sector: "Corporate",
      location: "Silvassa",
    },
    ...
    {
      name: "WELSPUN GUJARAT STAHL ROHREN LTD.",
      sector: "Corporate",
      location: "Dahej",
    },
      ...
      <div className="bg-primary text-white py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.p
            ...
            className="text-xl"
          >
            We have over {new Date().getFullYear() - 1990} years of experience
          </motion.p>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <AnimatedSection direction="left">
              <h2 className="section-heading">
                Vol-Tech Transformer Industries
              </h2>
              <h3 className="text-xl text-primary font-semibold mb-4">
                Get to know about our company
              </h3>
              <p className="text-gray-700 mb-6">
                Vol-Tech Industries is established in 1998. The company is based
                at Waghodia near by Baroda. The Company certified with An ISO
                9001-2000 in the January 2003. We also manufacture of furnace
                Transformer, Rectifier Duty Transformer and auto Voltage
                Transformer etc.
              </p>
            </AnimatedSection>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <AnimatedSection direction="up" delay={0.1}>
              <p className="text-gray-700 mb-6">
                We are one of the fast growing companies of Gujarat state who
                design, manufacture a complete rang of Quality Transformer. We
                manufacture to meet the National standard and manufacture under
                the stage inspection and performance.
              </p>
              <p className="text-gray-700">
                The company has supplied various capacity transformers to the
                government sector, Electricity Board's, Corporate sector and
                many other private Companies.
              </p>
            </AnimatedSection>
            <AnimatedSection direction="up" delay={0.2}>
              <p className="text-gray-700 mb-6">
                Unmatched Quality has always been the hallmark of VOL-TECH
                Industries. We have manufactured transformers up to 10 MVA and
                repaired up to 20 MVA.
              </p>
              <p className="text-gray-700">
                We take pleasure to introduce ourselves as a fast growing Power
                & Distribution Transformer Manufacturer and supplier of
                Transformers.
              </p>
            </AnimatedSection>
          </div>
      ...
      <section className="py-16 bg-primary/5">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-2 text-primary-dark">
              We Do Better
            </h2>
